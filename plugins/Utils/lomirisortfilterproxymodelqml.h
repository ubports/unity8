...
#ifndef LOMIRISORTFILTERPROXYMODELQML_H
#define LOMIRISORTFILTERPROXYMODELQML_H

#include <QSortFilterProxyModel>

class LomiriSortFilterProxyModelQML : public QSortFilterProxyModel
{
    Q_OBJECT
...
public:
    explicit LomiriSortFilterProxyModelQML(QObject *parent = 0);
...
#endif // LOMIRISORTFILTERPROXYMODELQML_H
