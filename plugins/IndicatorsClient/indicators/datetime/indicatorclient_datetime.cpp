...
QUrl IndicatorClientDateTime::iconComponentSource() const
{
    return QUrl("qrc:/indicatorsclient/qml/DatetimeIndicatorIcon.qml");
}

QUrl IndicatorClientDateTime::pageComponentSource() const
{
    return QUrl("qrc:/indicatorsclient/qml/DatetimeIndicatorPage.qml");
}
