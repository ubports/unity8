...
Q_LOGGING_CATEGORY(LOMIRI_APPMENU, "lomiri.appmenu", QtDebugMsg)

#define DEBUG_MSG qCDebug(LOMIRI_APPMENU).nospace().noquote() << "ApplicationMenuRegistry::"  << __func__
#define WARNING_MSG qCWarning(LOMIRI_APPMENU).nospace().noquote() << "ApplicationMenuRegistry::" << __func__
