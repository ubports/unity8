...
{
    m_networkingStatus = new connectivityqt::Connectivity(QDBusConnection::sessionBus(), this);
}
...
{
    if (m_networkingStatus->status() != connectivityqt::Connectivity::Status::Online) {
