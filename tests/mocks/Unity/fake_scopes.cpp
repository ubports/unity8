...
void Scopes::updateScopes()
{
    ...
    addScope(new Scope("LongPrimaryNavigation", "LongPrimaryNavigation",
            true, this, 1, false, QStringList() << "Meat" << "Vegetables" << "BBQ"
            << "Burritos" << "Pasta" << "Pancakes" << "Seafood" << "Soup"
            << "Bugs" << "Pudding" << "Chocolate" << "Gluten-Free" << "Hamburgers"
