        ...
        ItemSelector {
            ...
            delegate: OptionSelectorDelegate {
                ...
                subText: {
                    ...
                    var desc = ""
                    if (method === UbuntuSecurityPrivacyPanel.Swipe) {
                        name = i18n.ctr("Type of security method", "Swipe")
                        desc = i18n.ctr("Description of security method", "No security")
                    } else if (method === UbuntuSecurityPrivacyPanel.Passcode) {
                        name = i18n.ctr("Type of security method", "Passcode")
                        desc = i18n.ctr("Description of security method", "4 digits only")
                    } else {
                        name = i18n.ctr("Type of security method", "Passphrase")
                        desc = i18n.ctr("Description of security method", "Numbers and letters")
                    }
